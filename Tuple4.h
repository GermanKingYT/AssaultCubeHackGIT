...
{ 
  public: 
    ...
    inline void operator += (const Tuple4 &right){ 
      x +=right.x; 
      y +=right.y; 
      z +=right.z; 
      w +=right.w; 
    ...
    friend ostream & operator< ( ostream & out, const Tuple4 & right){ 
...
typedef Tuple4<float > CVector4; 
typedef Tuple4<float > Color4f; 
