...
{ 
  public: 
    ...
    inline void lookAt(Tuple3<T> &viewPosition, 
                       Tuple3<T> &viewFocus,  
                       Tuple3<T> &upVector) 
    { 
    ...
    inline Matrix4 &operator *=(const T f){ 
      for(int i = 0; i  16; i++) 
        m[i] *= f; 
      return *this; 
    } 
 
    inline void setInfinitePerspective(T fovy, T aspect, T zNear) 
    { 
    ...
    inline void setInfiniteFrustum(T left, T  right, T  bottom, T  top,T  zNear) 
    { 
      setIdentity(); 
    ...
    inline friend Tuple3<T> operator * (const Tuple3<T> &t,const Matrix4 &mat){ 
    ...
    inline friend Tuple3<T> operator * (const Matrix4 &mat,const Tuple3<T> &t){ 
      return Tuple3<T>(mat.m[ 0]*t.x + mat.m[ 4]*t.y + mat.m[ 8]*t.z + mat.m[12], 
                       mat.m[ 1]*t.x + mat.m[ 5]*t.y + mat.m[ 9]*t.z + mat.m[13], 
                       mat.m[ 2]*t.x + mat.m[ 6]*t.y + mat.m[10]*t.z + mat.m[14]); 
    } 
 
    inline friend Tuple4<T> operator * (const Matrix4 &mat, const Tuple4<T> &t){ 
    ...
    inline friend Tuple4<T> operator * (const Tuple4<T> &t,const Matrix4 &mat){ 
      return Tuple4<T>(mat.m[ 0]*t.x + mat.m[ 4]*t.y + mat.m[ 8]*t.z + mat.m[12]*t.w, 
                       mat.m[ 1]*t.x + mat.m[ 5]*t.y + mat.m[ 9]*t.z + mat.m[13]*t.w, 
                       mat.m[ 2]*t.x + mat.m[ 6]*t.y + mat.m[10]*t.z + mat.m[14]*t.w, 
                       mat.m[ 3]*t.x + mat.m[ 7]*t.y + mat.m[11]*t.z + mat.m[15]*t.w); 
    ...
    inline friend  void operator *=(Tuple3<T> &t,const Matrix4 &mat){ 
      t.set(mat.m[ 0]*t.x + mat.m[ 4]*t.y + mat.m[ 8]*t.z + mat.m[12], 
            mat.m[ 1]*t.x + mat.m[ 5]*t.y + mat.m[ 9]*t.z + mat.m[13], 
            mat.m[ 2]*t.x + mat.m[ 6]*t.y + mat.m[10]*t.z + mat.m[14]); 
    } 
 
    inline friend void operator *=(Tuple4<T> &t,const Matrix4 &mat){ 
  ...
  { 
    ...
    __forceinline void setElements(const T* elements){ 
       memcpy(m, elements, sizeof(T)*16); 
    } 
   ...
   __forceinline void setIdentity(){ 
    ...
    void setTranslation(const Tuple3<T> &t){ 
      setIdentity(); 
      m[12] =  t.x; 
      m[13] =  t.y; 
      m[14] =  t.z; 
    ...
    friend ostream & operator < ( ostream & out, const Matrix4 & right){ 
      return out < 
